...
const powerFiveBadges = [
  {
    ...
    description: 'Admin-assigned founding developer role.',
    requirement: 'Assigned the admin/developer role by an authorized admin.',
  ...
  },
  {
    ...
    description: 'Authorized campus leader with elevated privileges.',
    requirement: 'Assigned a verified campus leader role by authorized admins.',
  ...
  },
  {
    ...
    description: 'Unlock collaboration access by joining your first pod.',
    requirement: 'Join one collaboration pod for the first time.',
    progress: { current: 0, total: 1 },
    isUnlocked: false,
    isActive: false,
  ...
  },
  {
    ...
    description: 'Activate cross-campus messaging with your first bridge DM.',
    requirement: 'Send one inter-college or inter-domain direct message.',
    progress: { current: 0, total: 1 },
    isUnlocked: false,
    isActive: false,
...
export default function BadgeCenter({ user, setUser }) {
  ...
  const HARD_MODE_BADGE_DEFINITIONS = [
    {
      ...
      category: 'engagement',
      description: 'Drive one Global Hub thread to 50 total replies.',
      requirement: 'Create a Global Hub thread and grow that same thread to 50 replies.',
      unlockedBy: 'Start a Global Hub thread and push it to 50 total replies. One breakout thread is enough.',
    ...
    },
    {
      ...
      category: 'engagement',
      description: 'Sustain high activity with 150 replies in a rolling week.',
      requirement: 'Accumulate 150 replies inside any rolling 7-day window.',
      unlockedBy: 'Post 150 replies in a rolling 7-day window. Keep your reply pace consistent all week.',
    ...
    },
    {
      ...
      category: 'speed',
      description: 'Maintain a flawless streak of 20 sub-30-second inbox replies.',
      requirement: 'Record 20 consecutive inbox replies with latency at or below 30 seconds.',
      unlockedBy: 'Land 20 fast replies in a row with latency at 30 seconds or less. A slow reply resets the streak.',
    ...
    },
    {
      ...
      category: 'devotion',
      description: 'Show night consistency with late-hour Global Hub replies.',
      requirement: 'Post one qualifying Global Hub reply in the 2:00–3:59 AM IST window for 3 nights in a row.',
      unlockedBy: 'Reply in Global Hub between 2:00 and 3:59 AM IST for 3 consecutive nights.',
    ...
    },
    {
      ...
      description: 'Open new cross-domain DM links within a single day.',
      requirement: 'Start DMs with 5 distinct domains in a rolling 24-hour window.',
      unlockedBy: 'Send DMs to 5 distinct domains within a rolling 24-hour window.',
    ...
    },
    {
      ...
      description: 'Win the first-response race on help requests repeatedly.',
      requirement: 'Be the first reply on 25 ASK_HELP posts.',
      unlockedBy: 'Be the first reply on 25 ASK_HELP posts. Speed and first-response consistency matter.',
    ...
    },
    {
      ...
      category: 'sharing',
      description: 'Build resource impact by contributing across others\' threads.',
      requirement: 'Earn 50 resource thread points; each thread contributes at most once.',
      unlockedBy: 'Earn 50 thread points by posting resources or sharing links in other users\' threads. Each thread counts once.',
    ...
    },
    {
      ...
      category: 'leadership',
      description: 'Lead diverse collaboration rooms with broad college representation.',
      requirement: 'Create or fill 10 collab rooms where each includes 4+ distinct colleges.',
      unlockedBy: 'Create or fill 10 collab rooms with at least 4 distinct colleges in each room.',
    ...
    },
    {
      ...
      category: 'collaboration',
      description: 'Deliver deep contribution across many collab discussions.',
      requirement: 'Reach 20 replies in each of 15 different COLLAB_ROOM threads.',
      unlockedBy: 'In 15 different COLLAB_ROOM threads, reach 20 replies per room.',
    ...
    },
    {
      ...
      category: 'speed',
      description: 'Respond first and fast when a campus question appears.',
      requirement: 'Be the first reply and post it within 30 minutes.',
      unlockedBy: 'Be the first reply and do it within 30 minutes.',
    ...
    },
    {
      ...
      category: 'devotion',
      description: 'Protect an uninterrupted daily IST login chain for 100 days.',
      requirement: 'Complete 100 consecutive IST-day logins; missing a day resets progress.',
      unlockedBy: 'Log in for 100 consecutive IST days. Break the chain and the streak restarts from 1.',
    ...
    },
    {
      ...
      category: 'collaboration',
      description: 'Show broad collaboration presence across the collab-room network.',
      requirement: 'Reply in 50 unique COLLAB_ROOM threads.',
      unlockedBy: 'Reply in 50 distinct COLLAB_ROOM threads.',
    ...
    },
    {
      ...
      category: 'engagement',
      description: 'Become a major contributor in Global Hub conversations.',
      requirement: 'Post 1,500 replies counted only from Global Hub scope.',
      unlockedBy: 'Post 1,500 replies in Global Hub scope. Only Global Hub replies count.',
    ...
    },
    {
      ...
      description: 'Demonstrate elite poll timing by reading crowd momentum.',
      requirement: 'In 100 polls, vote for the option leading at the moment you vote.',
      unlockedBy: 'Vote for the option currently leading at vote time in 100 polls.',
    ...
    },
    {
      ...
      category: 'profile',
      description: 'Keep your profile complete and actively maintained.',
      requirement: 'Fill all required profile fields and save your profile updates.',
      unlockedBy: 'Complete your profile fully and save it.',
    ...
    },
    {
      ...
      category: 'conduct',
      description: 'Maintain clean conduct with one DM partner over a long streak.',
      requirement: 'Maintain a 500-message DM streak with one partner who keeps your report status clean.',
      unlockedBy: 'Build a 500-message streak with one DM partner who has not reported you.',
    ...
    },
    {
      ...
      category: 'helpfulness',
      description: 'Provide repeated help across distinct ASK_HELP discussions.',
      requirement: 'Reply to 50 different ASK_HELP posts where you are not the author.',
      unlockedBy: 'Reply to 50 distinct ASK_HELP posts where you are not the author.',
    ...
    },
    {
      ...
      category: 'engagement',
      description: 'Stay on top of event activity through timely notification reads.',
      requirement: 'Read 30 distinct EVENT notifications within 60 minutes of creation.',
      unlockedBy: 'Read 30 distinct EVENT notifications within 60 minutes. Re-reading the same event won\'t count.',
    ...
    },
    {
      ...
      description: 'Contribute across multiple academic branches in collaboration.',
      requirement: 'Participate in collab activity spanning 5 distinct academic branches.',
      unlockedBy: 'Participate across 5 distinct academic branches in collab activity.',
    ...
    },
    {
      ...
      category: 'penalty',
      description: 'Penalty state triggered by repeated valid reports from one reporter.',
      requirement: 'Three valid reports from the same user trigger a 24-hour DM ban for that user pair.',
      unlockedBy: 'If the same user reports you 3 times, a 24-hour DM ban applies for that user.',
  ...
  const findBadgeDefinition = (badge) => {
    ...
    return allDefinitions.find(def =>
      ...
      def.id === badge.id ||
      def.badgeId === badge.id ||
      def.name === badge.badgeName ||
      def.badgeName === badge.badgeName
    )
  }
  ...
  const hydrateHardModeBadges = (userId) => {
    ...
    return api.get(`/api/badges/hard-mode/${userId}`)
      .then(res => {
        const normalizedBadges = (res?.data?.badges || []).map(badge => {
          const definition = findBadgeDefinition(badge)
          ...
          return {
            ...
            id: badgeId,
            badgeId,
            name: badge.badgeName || badge.name || definition?.name || definition?.badgeName || badgeId,
            badgeName: badge.badgeName || badge.name || definition?.badgeName || definition?.name || badgeId,
      ...
      .catch(err => {
        console.error('[BadgeCenter] ❌ Hydration fetch failed:', err.response?.status, err.message)
        setHardModeBadges([])
      })
  }
  ...
  useEffect(() => {
    ...
    hydrateHardModeBadges(userId).finally(() => setHardModeBadgesLoading(false))
  }, [user?._id])
    ...
    try {
      ...
      const stompClient = new Stomp.Client({
        ...
        onConnect: () => {
          ...
          stompClient.subscribe('/user/queue/badge-unlock', (message) => {
            try {
              const badgeUnlock = JSON.parse(message.body)
              console.log('🎉 Badge update via WebSocket:', badgeUnlock)
            } catch {
              console.log('🎉 Badge update via WebSocket received')
            }
            hydrateHardModeBadges(userId)
          })
          console.log('✓ Subscribed to /user/queue/badge-unlock')
        },
        onStompError: (frame) => {
  ...
  // ✅ Keep moderation/penalty badges from user profile state
